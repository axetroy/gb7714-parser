...
import { BookFormatter } from './types/8.2-book-formatter.js';
import { ComponentPartFormatter } from './types/8.3-component-part-formatter.js';
import { SerialFormatter } from './types/8.4-serial-formatter.js';
import { JournalFormatter } from './types/8.5-journal-formatter.js';
import { NewspaperFormatter } from './types/8.5-newspaper-formatter.js';
import { ProceedingsFormatter } from './types/8.6-proceedings-formatter.js';
import { ThesisFormatter } from './types/8.7-thesis-formatter.js';
import { ReportFormatter } from './types/8.8-report-formatter.js';
import { StandardFormatter } from './types/8.9-standard-formatter.js';
import { PatentFormatter } from './types/8.10-patent-formatter.js';
import { WebPageFormatter } from './types/8.11-web-page-formatter.js';
import { ArchiveFormatter } from './types/8.12-archive-formatter.js';
import { MapFormatter } from './types/8.13-map-formatter.js';
import { DatasetFormatter } from './types/8.14-dataset-formatter.js';
import { PreprintFormatter } from './types/8.15-preprint-formatter.js';
