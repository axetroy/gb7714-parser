...
describe('万方数据真实引文测试', () => {
  describe('期刊论文 [J]', () => {
    it('方红卫-人工智能技术AI在水沙数学模型中的应用', () => {
      ...
      expect(reference.authors[0].surname).toBe('方红卫');
      expect(reference.authors[1].surname).toBe('张文俊');
    ...
    it('刘志伟-人工智能与企业投资效率提升', () => {
      ...
      expect(reference.type).toBe('J');
      expect(reference.authors.length).toBeGreaterThanOrEqual(2);
      expect(reference.authors[0].surname).toBe('刘志伟');
      expect(reference.authors[1].surname).toBe('张秋生');
    ...
    it('林耿-人工智能与地理学的未来', () => {
      ...
      expect(reference.authors[0].surname).toBe('林耿');
      expect(reference.authors[1].surname).toBe('叶超');
      expect(reference.authors[2].surname).toBe('黄耿志');
    ...
    it('郁建兴-人工智能时代的社会空间治理', () => {
      ...
      expect(reference.type).toBe('J');
      expect(reference.authors.length).toBeGreaterThanOrEqual(2);
      expect(reference.authors[0].surname).toBe('郁建兴');
      expect(reference.authors[1].surname).toBe('谭立力');
    ...
    it('杨锐-城市人工智能产业密度与企业合规', () => {
      ...
      expect(reference.type).toBe('J');
      expect(reference.authors.length).toBeGreaterThanOrEqual(2);
      expect(reference.authors[0].surname).toBe('杨锐');
      expect(reference.authors[1].surname).toBe('李荣荣');
    ...
    it('杨君侠-量子人工智能', () => {
      ...
      expect(reference.type).toBe('J');
      expect(reference.authors.length).toBeGreaterThanOrEqual(3);
      expect(reference.authors[0].surname).toBe('杨君侠');
      expect(reference.authors[1].surname).toBe('蔡淇智');
      expect(reference.authors[2].surname).toBe('郭晋荣');
    ...
    it('牟砚堂-人工智能全球治理前景分析', () => {
      ...
      expect(reference.type).toBe('J');
      expect(reference.authors.length).toBeGreaterThanOrEqual(2);
      expect(reference.authors[0].surname).toBe('牟砚堂');
      expect(reference.authors[1].surname).toBe('袁和静');
    ...
    it('熊易寒-人工智能时代的公共治理范式变革', () => {
      ...
      expect(reference.type).toBe('J');
      expect(reference.authors.length).toBeGreaterThanOrEqual(2);
      expect(reference.authors[0].surname).toBe('熊易寒');
      expect(reference.authors[1].surname).toBe('刘振琳');
    ...
    it('李悦荣-人工智能应用对企业税负的影响', () => {
      ...
      expect(reference.type).toBe('J');
      expect(reference.authors.length).toBeGreaterThanOrEqual(3);
      expect(reference.authors[0].surname).toBe('李悦荣');
      expect(reference.authors[1].surname).toBe('李建军');
      expect(reference.authors[2].surname).toBe('赵薇');
    ...
    it('牛嘉玮-人工智能应用人力资本结构与劳动力配置效率', () => {
      ...
      expect(reference.type).toBe('J');
      expect(reference.authors.length).toBeGreaterThanOrEqual(2);
      expect(reference.authors[0].surname).toBe('牛嘉玮');
      expect(reference.authors[1].surname).toBe('江小辉');
  ...
  describe('专利 [P]', () => {
    it('深圳火炎焱-文本内容快速分类管理方法', () => {
      ...
      expect(reference.authors[0].surname).toBe('深圳火炎焱人工智能有限公司');
    ...
    it('精英中汇-人工智能面部识别装置', () => {
      ...
      expect(reference.type).toBe('P');
      expect(reference.authors.length).toBe(1);
      expect(reference.authors[0].surname).toContain('精英中汇');
    ...
    it('蓝婴智能-语音交互型智能头盔', () => {
      ...
      expect(reference.authors[0].surname).toBe('深圳市蓝婴智能科技有限公司');
      expect(reference.authors[1].surname).toBe('深圳全智人工智能有限公司');
    ...
    it('上海人工智能创新中心-生成式AI合规审计', () => {
      ...
      expect(reference.type).toBe('P');
      expect(reference.authors.length).toBe(1);
      expect(reference.authors[0].surname).toBe('上海人工智能创新中心');
    ...
    it('陕西凯晨轩-开发工具插件同步方法', () => {
      ...
      expect(reference.type).toBe('P');
      expect(reference.authors.length).toBe(1);
      expect(reference.authors[0].surname).toBe('陕西凯晨轩人工智能科技有限公司');
    ...
    it('墨芯人工智能-芯片集群节点资源配置', () => {
      ...
      expect(reference.type).toBe('P');
      expect(reference.authors.length).toBe(1);
      expect(reference.authors[0].surname).toContain('墨芯人工智能');
    ...
    it('合肥瑞徽-软件信息异常筛查方法', () => {
      ...
      expect(reference.type).toBe('P');
      expect(reference.authors.length).toBe(1);
      expect(reference.authors[0].surname).toBe('合肥瑞徽人工智能研究院有限公司');
    ...
    it('中医科学院-人工智能视功能扩大方法', () => {
      ...
      expect(reference.type).toBe('P');
      expect(reference.authors.length).toBe(2);
      expect(reference.authors[0].surname).toBe('中国中医科学院眼科医院');
      expect(reference.authors[1].surname).toBe('大连理工大学人工智能大连研究院');
    ...
    it('人工智能金融科技-投资智能风险评估', () => {
      ...
      expect(reference.type).toBe('P');
      expect(reference.authors.length).toBe(1);
      expect(reference.authors[0].surname).toBe('人工智能金融科技实验室有限公司');
